...
/* Infineon::Device:BF-Stepping:0.0.1 */
...
/* Infineon::Device:SDK:SSC:0.1.7 */
#define RTE_DEVICE_SDK_SSC
/* Infineon::Device:SDK:TIMER3:0.1.7 */
#define RTE_DEVICE_SDK_TIMER3
/* Infineon::Device:SDK:UART:0.2.2 */
