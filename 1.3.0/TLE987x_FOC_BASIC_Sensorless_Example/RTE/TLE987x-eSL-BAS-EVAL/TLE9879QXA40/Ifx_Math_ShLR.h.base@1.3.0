...
/**
 * \file Ifx_Math_ShLR.h
 * \brief Provides functions which shift the fractional input x right or left by n bits and return the result without
 * any saturation or overflow detection.
 */

#ifndef IFX_MATH_SHLR_H
#define IFX_MATH_SHLR_H
#include "Ifx_Math.h"
#include "Ifx_Math_ShL.h"
#include "Ifx_Math_ShR.h"

/**
 *  \brief Return the result of the 16-bit fractional input parameter shifted by n bits without saturation or overflow
 * detection.
 *
 *
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_ShLR_F16(Ifx_Math_Fract16 x, sint8 n)
{
    ...
    if (n >= 0)
    {
        shiftReturn = Ifx_Math_ShL_F16(x, (uint8)(n));
    }
    else
    {
        negativeShift = -n;
...
/**
 *  \brief Return the result of the 32-bit fractional input parameter shifted by n bits without saturation or overflow
 * detection.
 *
 *
 ...
 */
static inline Ifx_Math_Fract32 Ifx_Math_ShLR_F32(Ifx_Math_Fract32 x, sint8 n)
{
    /* Return value of the function */
    ...
    if (n >= 0)
    {
        shiftReturn = Ifx_Math_ShL_F32(x, (uint8)(n));
    }
    else
    {
