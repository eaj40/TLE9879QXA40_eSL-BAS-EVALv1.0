 ...
 * numerator and y the denominator, left shifted by n and saturated between the minimum and maximum of the corresponding
...
#ifndef IFX_MATH_DIVSHLSAT_H
#define IFX_MATH_DIVSHLSAT_H
#include "Ifx_Math.h"
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_DivShLSat_F16(Ifx_Math_Fract16 x, Ifx_Math_Fract16 y, uint8 n)
{
    ...
    {
        divReturn = Ifx_Math_Sat_F16_F32((Ifx_Math_ShL_F32((Ifx_Math_Fract32)x, n) / (Ifx_Math_Fract32)y));
    }
 ...
 *  \param [in] n Number of bits to left shift the division result, between 0 and 32
 *
 *  \return 32-bit fractional number with the format Q(a-b+n)
 */
static inline Ifx_Math_Fract32 Ifx_Math_DivShLSat_F32(Ifx_Math_Fract32 x, Ifx_Math_Fract32 y, uint8 n)
{
    return Ifx_Math_Sat_F32_F64(Ifx_Math_DivShL_p_F64_F32F32(x, y, n));
}


#endif /*IFX_MATH_DIVSHLSAT_H*/
