 ...
 * and subtracted from the fractional number x, without saturation and overflow detection.
 */

#ifndef IFX_MATH_MULSHRSUB_H
#define IFX_MATH_MULSHRSUB_H
#include "Ifx_Math.h"
 ...
 */
static inline Ifx_Math_Fract16 Ifx_Math_MulShRSub_F16(Ifx_Math_Fract16 x, Ifx_Math_Fract16 y, Ifx_Math_Fract16 z,
                                                      uint8 n)
{
    return Ifx_Math_Sub_F16(x, Ifx_Math_MulShR_F16(y, z, n));
}
 ...
 */
static inline Ifx_Math_Fract32 Ifx_Math_MulShRSub_F32(Ifx_Math_Fract32 x, Ifx_Math_Fract32 y, Ifx_Math_Fract32 z,
                                                      uint8 n)
{
    return Ifx_Math_Sub_F32(x, Ifx_Math_MulShR_F32(y, z, n));
}


/**
 *  \brief Calculates the 32-bit fractional product of two 16-bit fractional numbers, y and z, right shifted by n, and
 * subtract it from the 16-bit fractional number x, without saturation and overflow detection.
 *
 *
 *  \param [in] x 32-bit fractional number with the format Q(a+b-n)
 ...
 *  \return 32-bit fractional number with the format Q(a+b-n)
 */
static inline Ifx_Math_Fract32 Ifx_Math_MulShRSub_F32_F32F16F16(Ifx_Math_Fract32 x, Ifx_Math_Fract16 y,
                                                                Ifx_Math_Fract16 z, uint8 n)
{
    return Ifx_Math_Sub_F32(x, Ifx_Math_MulShR_F32_F16F16(y, z, n));
}


#endif /*IFX_MATH_MULSHRSUB_H*/
